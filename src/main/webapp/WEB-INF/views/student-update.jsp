...
<body>
		...
		<div class="main_contents">
			<div id="sub_content">
				<c:url value="/students/${student.id}/update" var="registrationUrl" />
				<form id="myForm" action="${registrationUrl}" method="post"
					enctype="multipart/form-data">

					<h2 class="col-md-6 offset-md-2 mb-5 mt-4">Update Student
						Information</h2>
					<div class="row mb-4">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
						 <input type="date" class="form-control" id="dob" name="dob" value="${student.dob}" required onchange="validateAge()">
					...
					<fieldset class="row mb-4">
						...
						<c:set var="isMale" value="${student.gender==0? 'checked':''}"/>
						<c:set var="isFemale" value="${student.gender==1? 'checked':''}"/>
						<div class="col-md-4">
							<div class="form-check-inline">
								<input class="form-check-input" type="radio" name="gender"
									id="gridRadios1" value="0" ${isMale}> <label
									class="form-check-label" for="gridRadios1"> Male </label>
							</div>
							<div class="form-check-inline">
								<input class="form-check-input" type="radio" name="gender"
									id="gridRadios2" value="1" ${isFemale}> <label
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
					        <input type="tel" id="phone" name="phone"  class="form-control" placeholder="e.g., 09-123456789" required
					               oninput="validatePhoneNumber(this);" value="${student.phone}">
					        <br>
						</div>
					</div>
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<select class="form-select" aria-label="Education" id="education"
								name="education">
								<option selected>${student.education}</option>
