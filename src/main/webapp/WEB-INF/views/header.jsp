...
<body>
	...
	<nav
		class="navbar navbar-expand-lg bg-white px-5 py-3 border-bottom w-m-full">
		<div class="container-fluid w-m-full ">
			...
			<div class="d-flex align-items-center">
				...
				<button class="btn btn-outline-danger d-flex justify-content-center align-items-center" type="button"
					onclick="location.href='${logouturl}'"><i class='bx bx-log-out me-2'></i>Log out</button>
			</div>
		</div>
	</nav>
	...
	<div class="sidenav">
			...
			<a
				href="${studentList}" class="d-flex  align-items-center"><i class='bx bxs-id-card me-2'></i>Manage student</a>
            ...
            <c:url var="addCourses" value="/course/add"/>
				<a href='${addCourses}' class="d-flex  align-items-center"><i class='bx bxs-category-alt me-2'></i>Manage courses</a>
