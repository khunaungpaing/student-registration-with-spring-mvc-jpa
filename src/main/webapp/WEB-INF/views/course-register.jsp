...
<body>
			...
			<div id="sub_content">
				<form action="add" method="post">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" id="id" value="${courseId}" name="courseId" disabled>
						</div>
					</div>
		...
		<div class="position-fixed end-0 p-3" style="z-index: 11">
			<div id="successToast" class="toast hide" role="alert"
				...
				<div class="toast-body">Successfully created course</div>
			</div>
		</div>
