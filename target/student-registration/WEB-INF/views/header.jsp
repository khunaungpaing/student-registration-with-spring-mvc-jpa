...
<form action="change-password" id="password-form">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row mb-4">
                        ...
                        <label for="password" class="col-md-4 col-form-label">Passowrd</label>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-1"></div>
                        <label for="confirm-password" class="col-md-4 col-form-label">Confirm
                            Passowrd</label>
                        <div class="col-md-6">
